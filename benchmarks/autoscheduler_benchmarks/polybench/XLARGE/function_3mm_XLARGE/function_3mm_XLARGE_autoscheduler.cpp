...

{
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A, &b_B, &b_C, &b_D, &b_E}, "function_3mm_XLARGE.o", "./function_3mm_XLARGE_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_3mm_XLARGE_explored_schedules.json", true);
	}else{
