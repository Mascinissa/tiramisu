...
int main(int argc, char **argv)
 {
  ...
  prepare_schedules_for_legality_checks();
	...
	auto_scheduler::evaluate_by_execution *exec_eval = new auto_scheduler::evaluate_by_execution({&b_A, &b_p, &b_r, &b_q, &b_s}, "function_bicg_XLARGE.o", "./function_bicg_XLARGE_wrapper");
	...
	if (explore_by_execution){
		...
		as.sample_search_space("./function_bicg_XLARGE_explored_schedules.json", true);
	}else{
