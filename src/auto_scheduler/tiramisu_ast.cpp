...
*/
    ...
    // Getting the AST nodes to change
    ...
    // Applying the transformation matrix to get the transformed program loops     
    ...
    // Update the AST with the new loop bounds
...
void syntax_tree::transform_ast_by_skewing_positive(const optimization_info &info){
    ...
    node_1->transform_accesses_with_skewing_positive(info.l0_fact,info.l1_fact,info.l2_fact,info.l3_fact);
